...
function ambiance(nom){
  ...
  switch(nom){
    /* ---- Les cinq lieux de « Le Sceau de la République » ---- */
    case "cour":       ambianceJardins(noeuds); break;   // cour du Palais-Royal
    case "archives":   ambianceAccueil(noeuds); break;   // salle des textes, feutree
    case "hemicycle":  ambianceAssemblee(noeuds); break; // Assemblee nationale
    case "senat":      ambianceJardins(noeuds); break;   // jardin du Luxembourg
    case "conseil":    ambianceAccueil(noeuds); break;   // salle des seances
