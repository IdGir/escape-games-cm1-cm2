 ...
 * @param {string} nom - motte|remparts|grandesalle|village|moulin|accueil
 */
function ambiance(nom){
  ...
  switch(nom){
    /* ---- Les cinq lieux de « Le Secret du donjon » ---- */
    case "motte":       ambianceJardins(noeuds); break;    // plein air, oiseaux
    case "remparts":    ambiancePluie(noeuds); break;      // vent et pluie sur la pierre
    case "grandesalle": ambianceAccueil(noeuds); break;    // grande salle, feutré
    case "village":     ambianceJardins(noeuds); break;    // champs, oiseaux
    case "moulin":      ambianceImprimerie(noeuds); break; // meule et roue qui tournent en rythme
