...
function son(nom){
  ...
  switch(nom){
    ...
    /* Déverrouillage — une opération du protocole est trouvée */
    case "deverrouille": {
...
function ambiance(nom){
  ...
  switch(nom){
    /* ---- Les cinq salles du laboratoire de Madame Mélange ---- */
    case "balances":   ambianceAccueil(noeuds); break;   // salle feutree
    case "cuisine":    ambianceAccueil(noeuds); break;   // cuisine d'essai
    case "fioles":     ambianceAccueil(noeuds); break;   // salle des fioles
    case "atelier":    ambianceImprimerie(noeuds); break; // atelier : bruits mecaniques doux
    case "saline":     ambianceJardins(noeuds); break;   // plein air, face aux marais
