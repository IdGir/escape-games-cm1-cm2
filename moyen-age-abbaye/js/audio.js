 ...
 * @param {string} nom - reims|aix|scriptorium|hoteldieu|chantier|accueil
 */
function ambiance(nom){
  ...
  switch(nom){
    /* ---- Les cinq lieux de « Le Manuscrit de l'abbaye » ---- */
    case "reims":       ambianceAssemblee(noeuds); break; // foule du baptême, murmure
    case "aix":         ambianceAccueil(noeuds); break;   // palais, feutré
    case "scriptorium": ambianceAccueil(noeuds); break;   // silence du scriptorium
    case "hoteldieu":   ambianceAccueil(noeuds); break;   // grande salle calme
    case "chantier":    ambianceImprimerie(noeuds); break; // outils qui frappent en rythme
