...
function imprimerBilan(){
  ...
  const mention = part>=0.90 ? "🏆 Maître inventeur"
  ...
  zone.innerHTML = `
    ...
    <div class="impr-titre-principal">Bilan — « L'Atelier de l'inventeur »</div>
    <div class="impr-soustitre">Escape game de sciences et technologie · les objets techniques · cycle 3</div>
  ...
  return `<div class="impr-entete">
    <div class="gauche">
      ...
      <div>
        ...
        <div>L'Atelier de l'inventeur · les objets techniques · cycle 3</div>
      </div>
    </div>
    <div class="droite">
...
function piedPageFiche(page, total, section){
  return `<div class="impr-pied">
    <div>${section} · « L'Atelier de l'inventeur » · ${ETAT.niveau||""}</div>
...
function qcmHTML(niveau, corrige){
  ...
  let html = `
    ...
    <div class="impr-bandeau-tricolore"></div>
    <div class="impr-titre-principal">QCM — Les objets techniques</div>
...
function etudesDocsHTML(niveau, corrige){
  ...
  let html = `
    ...
    <div class="impr-titre-principal">Étude de documents</div>
      <div class="impr-soustitre">Niveau ${niveau} · les objets techniques</div>
    ${!corrige?cartoucheEleve(ETAT.equipe, niveau):""}
    <div class="${corrige?"impr-corrige":""}">
  `;
  docs.forEach((d, i)=>{
