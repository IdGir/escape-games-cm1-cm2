...
function ambiance(nom){
  ...
  switch(nom){
    /* ---- Les cinq lieux de « L'Atelier de l'inventeur » ---- */
    case "atelier":    ambianceJardins(noeuds); break;   // entrée de l'atelier, pluie dehors
    case "etabli":     ambianceAccueil(noeuds); break;   // établi, calme
    case "materiaux":  ambianceAccueil(noeuds); break;   // matériauthèque, feutrée
    case "machines":   ambianceAssemblee(noeuds); break; // salle des machines, rumeur
    case "montage":    ambianceAccueil(noeuds); break;   // coin montage
...
/* ---- Pluie douce (entrée de l'atelier) ---- */
