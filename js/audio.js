...
function ambiance(nom){
  ...
  switch(nom){
    case "palais-royal": ambiancePluie(noeuds); break;
    case "imprimerie":   ambianceImprimerie(noeuds); break;
    case "tuileries":    ambianceJardins(noeuds); break;
    case "bastille":     ambianceEmeute(noeuds); break;
    case "assemblee":    ambianceAssemblee(noeuds); break;
